...
<body style="background-color: #679267;">
    <nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark">
      ...
      <div 
        ...
        >
        <h2 class="text-light fw-bold mb-4"><u>Edit School Admin Profile</u></h2>
      <img 
      ...
      <main class="container-fluid mb-5 rounded p-3 d-flex flex-column align-items-center">    
            <div 
                ...
                style="width: 400px;"    
            >
               <form action="includes/editSchoolAdminProfile.inc.php" class="fw-bold" method="post">
                ...
                <div class="d-flex justify-content-center mt-3 mb-4">
                    <button 
                      ...
                      id="editSchoolAdminProfile-btn"
                      name = "editSchoolAdminProfile-btn">
                        Confirm Information
                    </button>
